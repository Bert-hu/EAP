    ...
    public partial class MainForm : UIForm
    {
        ...
        private void checkBox_checkrecipe_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox_checkrecipe.Checked == false)
            {
                ...
                {
                    if (form.Value == _configuration.GetSection("Custom")["Password"])
                    {
        ...
        {
            var machineRecipePath = _configuration.GetSection("Custom")["MachineRecipePath"];
            ...
            if (res.Result)
            {
                traLog.Info(res.Message);
            }
            else
            {
                traLog.Error(res.Message);
            }
        }
