...
namespace EAP.Client.Secs.PrimaryMessageHandler.EventHandler
{
    internal class LoadLastPanel : CommonAgvEvent, IEventHandler
    {
        ...
        public LoadLastPanel(RabbitMqService rabbitMqService, ISecsGem secsGem, CommonLibrary commonLibrary, IServiceProvider serviceProvider,IConfiguration configuration)
        {
