...
{
    internal class Auto1Full : CommonAgvEvent, IEventHandler
    {
        ...
        public Auto1Full(RabbitMqService rabbitMqService, ISecsGem secsGem, CommonLibrary commonLibrary, IServiceProvider serviceProvider)
        {
