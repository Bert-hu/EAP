...
{
    internal class TrayFeed : CommonAgvEvent, IEventHandler
    {
        ...
        public TrayFeed(RabbitMqService rabbitMqService, ISecsGem secsGem, CommonLibrary commonLibrary, IServiceProvider serviceProvider)
        {
