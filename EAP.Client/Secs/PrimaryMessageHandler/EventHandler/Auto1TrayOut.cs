...
{
    internal class Auto1TrayOut : CommonAgvEvent, IEventHandler
    {
        ...
        public Auto1TrayOut(RabbitMqService rabbitMqService, ISecsGem secsGem, CommonLibrary commonLibrary, IServiceProvider serviceProvider)
        {
