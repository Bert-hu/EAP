...
{
    internal class Auto1TrayEmpty : CommonAgvEvent, IEventHandler
    {
        ...
        public Auto1TrayEmpty(RabbitMqService rabbitMqService, ISecsGem secsGem, CommonLibrary commonLibrary, IServiceProvider serviceProvider)
        {
