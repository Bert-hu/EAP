...
using EAP.Client.RabbitMq.TransactionHandler;
...
namespace EAP.Client.Secs.PrimaryMessageHandler.EventHandler
{
    internal class ProcessStateChanged : IEventHandler
    {
        ...
        public static bool NeedChangeRecipe { get; set; } = false;
        public static string ChangeRecipeName { get; set; } = string.Empty;
        public static DateTime ChangeDateTime { get; set; } = DateTime.MinValue;
