                ...
                else
                {
                    ...
                    if (request.Result == "Finished")
                    {
                        ...
                        if (task.Type == AgvTaskType.Input)
                        {
                            ...
                            dbgLog.Info($"{machine.Id} 更新上料口盘数 {machine.InputTrayNumber}, 当前Lot {machine.CurrentLot}");
                        }
                        ...
                        else if (task.Type == AgvTaskType.InputOutput)
                        {
                            ...
                            dbgLog.Info($"{machine.Id} 更新上料口盘数 {machine.InputTrayNumber}, 当前Lot {machine.CurrentLot}， 出料口盘数 0");
                        }
